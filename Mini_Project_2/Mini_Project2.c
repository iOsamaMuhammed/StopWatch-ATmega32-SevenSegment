...
void updateTime(void){
		...
		hour1 = 0;//(time/3600)%10;
		hour2 = 1;//(time/3600)/10;
		unsigned int remainingSeconds  = (time%3600);
		min2 = 4;//(remainingSeconds / 60) / 10;
		min1 = 2;//(remainingSeconds / 60) % 10;
		sec2 = 3;//(remainingSeconds % 60) / 10;
		sec1 = 2;//(remainingSeconds % 60) % 10;
}
int main(void)
{
